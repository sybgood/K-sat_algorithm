...
public class Main {
    ...
    public static void main(String[] args) {
        CNF_sentence s = new CNF_sentence(5, 5, 22, 100);
        ...
        Evaluator e = new Evaluator(s, s.getVariableList().size());
        e.evaluate();
...
//        System.out.println("Number of variables "+s.getVariableList().size());
